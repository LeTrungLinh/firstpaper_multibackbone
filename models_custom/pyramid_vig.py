...
if __name__ == '__main__':
    ...
    model = pvig_b_224_gelu()
    torchsummary.summary(model, (3, 224, 224), device='cpu')


    # ### test grapher and ffn ###
    # # create an instance of the Grapher class
    # grapher = Grapher(in_channels=128)

    # # generate a random input tensor
    # input_tensor = torch.randn(1, 128, 56, 56)

    # # pass the input tensor to the Grapher instance and obtain the output tensor
    # output_tensor = grapher(input_tensor)
    # output_tensor = FFN(input_tensor, input_tensor*4)
